...
i;
for (p in src)
if (value = src[p], p in src && !this._sameValue(dst[p], value))
if (p == 'className')
...
else if (wjcCore.isArray(value) && wjcCore.isArray(dst[p]) && (dstArr = dst[p], srcArr = value, srcArr.length == dstArr.length))
