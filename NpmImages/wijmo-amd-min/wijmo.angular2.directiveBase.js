/*
    ...
    *
    */
define(["require", "exports", "wijmo/wijmo", "@angular/core"], function(require, exports, wjcCore, core_1)
{
"use strict";
...
var WjComponentResolvedMetadata,
WjDirectiveBehavior,
Ng2Utils,
WjValueAccessor,
moduleExports,
...
nodes_1,
curNode;
if (useTemplateRoot === void 0 && (useTemplateRoot = !1), viewRef = viewContainerRef.createEmbeddedView(templateRef, {}, viewContainerRef.length), nodes = viewRef.rootNodes, useTemplateRoot && nodes.length === 1)
rootEl = nodes[0];
else
for (rootEl = document.createElement('div'), _i = 0, nodes_1 = nodes; _i < nodes_1.length; _i++)
curNode = nodes_1[_i],
...
WjValueAccessor.decorators = [{type: core_1.Injectable}, ];
WjValueAccessor.ctorParameters = function()
{
return [null, ]
};
...
WjDirectiveBaseModule.ctorParameters = function()
{
return []
};
