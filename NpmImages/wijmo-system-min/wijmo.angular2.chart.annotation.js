...
WjFlexChartAnnotationLayer.meta = {outputs: wjFlexChartAnnotationLayerMeta.outputs};
...
WjFlexChartAnnotationText.meta = {outputs: wjFlexChartAnnotationTextMeta.outputs};
...
WjFlexChartAnnotationEllipse.meta = {outputs: wjFlexChartAnnotationEllipseMeta.outputs};
...
WjFlexChartAnnotationRectangle.meta = {outputs: wjFlexChartAnnotationRectangleMeta.outputs};
...
WjFlexChartAnnotationLine.meta = {outputs: wjFlexChartAnnotationLineMeta.outputs};
...
WjFlexChartAnnotationPolygon.meta = {outputs: wjFlexChartAnnotationPolygonMeta.outputs};
...
WjFlexChartAnnotationCircle.meta = {outputs: wjFlexChartAnnotationCircleMeta.outputs};
...
WjFlexChartAnnotationSquare.meta = {outputs: wjFlexChartAnnotationSquareMeta.outputs};
...
WjFlexChartAnnotationImage.meta = {outputs: wjFlexChartAnnotationImageMeta.outputs};
