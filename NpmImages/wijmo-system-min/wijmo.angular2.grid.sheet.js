...
WjGridSheetModule;
return {
setters: [function(wjcGridSheet_1)
{
...
WjFlexSheet.meta = {
outputs: wjFlexSheetMeta.outputs, changeEvents: {selectedSheetChanged: ['selectedSheetIndex']}
};
WjFlexSheet.decorators = [{
type: core_1.Component, args: [{
selector: wjFlexSheetMeta.selector, template: wjFlexSheetMeta.template, inputs: wjFlexSheetMeta.inputs, outputs: wjFlexSheetMeta.outputs, providers: [{
...
WjSheet.meta = {outputs: wjSheetMeta.outputs};
WjSheet.decorators = [{
type: core_1.Component, args: [{
selector: wjSheetMeta.selector, template: wjSheetMeta.template, inputs: wjSheetMeta.inputs, outputs: wjSheetMeta.outputs, providers: [{
provide: 'WjComponent', useExisting: core_2.forwardRef(function()
{
return WjSheet
})
