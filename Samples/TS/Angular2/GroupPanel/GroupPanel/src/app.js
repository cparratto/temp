...
AppModule = __decorate([
    core_1.NgModule({
        imports: [wijmo_angular2_input_1.WjInputModule, wijmo_angular2_grid_1.WjGridModule, wijmo_angular2_grid_grouppanel_1.WjGridGrouppanelModule, platform_browser_1.BrowserModule],
        declarations: [AppCmp],
