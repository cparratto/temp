...
var TemplatesCmp = (function (_super) {
    ...
    function TemplatesCmp(dataSvc) {
        ...
        _this.someNumber = 123;
        _this.someSize = 'large';
        _this.sizes = [
            'tiny',
            'extra-small',
            'small',
        ...
        _this._tplInputNumber = wjNg2Input.WjInputNumber.controlTemplate;
        wjNg2Input.WjInputNumber.controlTemplate = '<div style="position:relative;background-color:inherit">' +
            ...
            '</table>' +
            '</div>';
        _this._tplComboBox = wjNg2Input.WjComboBox.controlTemplate;
        wjNg2Input.WjComboBox.controlTemplate = '<div style="position:relative;background-color:inherit;">' +
            ...
            '</div>';
        _this._tplCalendar = wjNg2Input.WjCalendar.controlTemplate;
