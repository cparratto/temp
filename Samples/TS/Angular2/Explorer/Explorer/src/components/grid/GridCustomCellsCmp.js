...
var GridCustomCellsCmp = (function (_super) {
    ...
    function GridCustomCellsCmp(dataSvc, sparkSvc) {
        ...
        _this.itemFormatter = function (panel, r, c, cell) {
        ...
        _this.data = dataSvc.getData(1000);
        _this.sparkSvc = sparkSvc;
        return _this;
    }
...
GridCustomCellsCmp = __decorate([
    ...
    __param(0, core_1.Inject(DataSvc_1.DataSvc)), __param(1, core_1.Inject(SparkSvc_1.SparkSvc))
], GridCustomCellsCmp);
