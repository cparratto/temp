...
var GridEditingCmp = (function (_super) {
    ...
    function GridEditingCmp(dataSvc) {
        ...
        _this._amount = 0;
        _this._amount2 = 0;
        _this.selectionChangedHandler = function () {
            var flex = _this.flex;
            _this._updateView();
        ...
        _this.products = _this.dataSvc.getProducts();
        _this.colors = _this.dataSvc.getColors();
        _this.countries = _this.dataSvc.getSomeCountries();
        _this._applyFilter();
        return _this;
    }
