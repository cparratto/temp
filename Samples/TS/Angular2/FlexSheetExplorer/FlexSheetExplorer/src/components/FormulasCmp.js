...
var FormulasCmp = (function () {
    function FormulasCmp() {
    }
    FormulasCmp.prototype.flexSheetInit = function (flexSheet) {
        var self = this;
        if (flexSheet) {
            flexSheet.deferUpdate(function () {
                var sheetIndex;
                for (sheetIndex = 0; sheetIndex < flexSheet.sheets.length; sheetIndex++) {
                    flexSheet.sheets.selectedIndex = sheetIndex;
                    switch (flexSheet.sheets[sheetIndex].name) {
                        case 'Basic Operators':
                            self._generateBasicOperatorsSheet(flexSheet);
                            break;
                        case 'Math':
                            self._generateMathSheet(flexSheet);
                            break;
                        case 'Logical':
                            self._generateLogicalSheet(flexSheet);
                            break;
                        case 'Text':
                            self._generateTextSheet(flexSheet);
                            break;
                        case 'Aggregate':
                            self._generateAggregateSheet(flexSheet);
                            break;
                        case 'Date':
                            self._generateDateSheet(flexSheet);
                            break;
                        case 'Lookup & Reference':
                            self._generateLookupReferenceSheet(flexSheet);
                            break;
                        case 'Financial':
                            self._generateFinancialSheet(flexSheet);
                            break;
                        case 'Summary':
                            self._generateSummraySheet(flexSheet);
                            break;
                    }
                }
    ...
    FormulasCmp.prototype._generateBasicOperatorsSheet = function (flexSheet) {
    ...
    FormulasCmp.prototype._generateMathSheet = function (flexSheet) {
    ...
    FormulasCmp.prototype._generateLogicalSheet = function (flexSheet) {
    ...
    FormulasCmp.prototype._generateTextSheet = function (flexSheet) {
    ...
    FormulasCmp.prototype._generateAggregateSheet = function (flexSheet) {
    ...
    FormulasCmp.prototype._generateDateSheet = function (flexSheet) {
    ...
    FormulasCmp.prototype._generateLookupReferenceSheet = function (flexSheet) {
    ...
    FormulasCmp.prototype._generateFinancialSheet = function (flexSheet) {
    ...
    FormulasCmp.prototype._generateSummraySheet = function (flexSheet) {
...
], FormulasCmp.prototype, "flexSheet", void 0);
FormulasCmp = __decorate([
    core_1.Component({
        selector: 'formulas-cmp',
        templateUrl: 'src/components/formulasCmp.html',
    })
], FormulasCmp);
exports.FormulasCmp = FormulasCmp;
var routing = router_1.RouterModule.forChild([
    { path: '', component: FormulasCmp }
]);
var FormulasModule = (function () {
    function FormulasModule() {
    }
    return FormulasModule;
}());
FormulasModule = __decorate([
    core_1.NgModule({
        imports: [common_1.CommonModule, routing, wijmo_angular2_grid_sheet_1.WjGridSheetModule],
        declarations: [FormulasCmp],
    })
], FormulasModule);
exports.FormulasModule = FormulasModule;
//# sourceMappingURL=FormulasCmp.js.map