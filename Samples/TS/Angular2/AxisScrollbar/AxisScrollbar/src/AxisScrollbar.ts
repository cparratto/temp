...
import * as wjcSelf from './AxisScrollbar';
...
export class AxisScrollbar {
    ...
    // host
    private _chart: wjcChart.FlexChartCore = null;
    private _axis: wjcChart.Axis = null;
    private _rangeSlider: wjcChartInteraction._RangeSlider = null;
    ...
    /**
        ...
        */
    constructor(axis: wjcChart.Axis, options?) {
        if (!axis) {
    ...
    private  _createScrollbar() {
        ...
        this._rangeSlider = new wjcChartInteraction._RangeSlider(this._slbarContainer,
    ...
    private _refresh() {
        var chartHostEle = this._chart.hostElement, 
            ...
            rOffset = wjcCore.getElementRect(this._slbarContainer);
