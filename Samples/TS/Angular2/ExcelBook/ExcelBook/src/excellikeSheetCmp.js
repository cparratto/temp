...
var wjcGridSheetChart = require("./wijmo/wijmo.grid.sheet.chart");
...
var ExcellikeSheetCmp = (function () {
    function ExcellikeSheetCmp(dataSvc) {
        ...
        this.chartTypes = ['Column', 'Bar', 'Scatter', 'Line', 'LineSymbols', 'Area', 'Spline', 'SplineSymbols', 'SplineArea'];
    ...
    ExcellikeSheetCmp.prototype.lbChartTypesInit = function (lbChartTypes) {
        var self = this;
        if (lbChartTypes) {
    ...
    ExcellikeSheetCmp.prototype.showChartTypes = function (e) {
        var lbChartTypes = this.lbChartTypes, target = e.target, offset;
    ...
    ExcellikeSheetCmp.prototype._addChart = function () {
        var lbChartTypes = this.lbChartTypes, chartType = null;
...
__decorate([
    core_1.ViewChild('lbChartTypes')
], ExcellikeSheetCmp.prototype, "lbChartTypes", void 0);
