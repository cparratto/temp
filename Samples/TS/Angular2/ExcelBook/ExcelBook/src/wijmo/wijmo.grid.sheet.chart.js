...
var wjcSelf = require("./wijmo.grid.sheet.chart");
...
}(wjcGridSheet._UndoAction));
exports._ChartInsertAction = _ChartInsertAction;
/*
...
var _ChartRemoveAction = (function (_super) {
    ...
    function _ChartRemoveAction(chartEngine, chartObj) {
        ...
        _this._chartRect = new wjcCore.Rect(chartHost.offsetLeft, chartHost.offsetTop, chartHost.offsetWidth, chartHost.offsetHeight);
        _this._chartContainerRect = new wjcCore.Rect(chartContainer.offsetLeft, chartContainer.offsetTop, chartContainer.offsetWidth, chartContainer.offsetHeight);
        return _this;
    }
    /*
     * Overrides the undo method of its base class @see:_UndoAction.
...
}(wjcGridSheet._ColumnsChangedAction));
exports._ChartColumnsChangedAction = _ChartColumnsChangedAction;
/*
 * Defines the _ChartRowsChangedAction class.
 *
 * It deals with the undo\redo for insert or delete column of the flexsheet.
 */
var _ChartRowsChangedAction = (function (_super) {
...
}(wjcGridSheet._RowsChangedAction));
exports._ChartRowsChangedAction = _ChartRowsChangedAction;
/*
...
var ChartEngine = (function () {
    ...
    function ChartEngine(owner) {
        this._charts = [];
        this._chartMousePosition = new wjcCore.Point();
        this._chartOriginalBounds = new wjcCore.Rect(0, 0, 0, 0);
        this._containerOriginalBounds = new wjcCore.Rect(0, 0, 0, 0);
        this._movingChart = false;
        this._resizingChart = false;
        this._lastScrollPosition = new wjcCore.Point();
        this._undoing = false;
        this._owner = owner;
        this._init();
    }
    ...
    ChartEngine.prototype._generateChartData = function (cellRanges) {
        var selections = (cellRanges ? cellRanges : this._owner.selectedSheet.selectionRanges), selection, datas, index, startRowIndex, item, seriesBinding, seriesIndex, lastSeriesIndex, needSeriesBinding, xIndex, cellVal;
        datas = [];
        seriesIndex = 0;
    ...
    ChartEngine.prototype._getChartRect = function () {
        var root = this._owner['_root'], cells = this._owner['_eCt'], rect = new wjcCore.Rect(0, 0, 468, 284), elementWidth, elementHeight;
    ...
    ChartEngine.prototype._mouseDown = function (e, hostElement) {
        ...
        hostElement.focus();
        this._containerRect = new wjcCore.Rect(cells.offsetLeft, cells.offsetTop, root.clientWidth > cells.clientWidth ? cells.clientWidth : (root.clientWidth - rowHeader.clientWidth), root.clientHeight > cells.clientHeight ? cells.clientHeight : (root.clientHeight - columnHeader.clientHeight));
...
exports.ChartEngine = ChartEngine;
//# sourceMappingURL=wijmo.grid.sheet.chart.js.map