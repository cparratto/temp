...
var RangeSelectorModule = (function () {
    function RangeSelectorModule() {
    }
    return RangeSelectorModule;
}());
RangeSelectorModule = __decorate([
    core_1.NgModule({
...
exports.RangeSelectorModule = RangeSelectorModule;
