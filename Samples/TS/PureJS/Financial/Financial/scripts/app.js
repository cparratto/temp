onload = function () {
    ...
    var theGrid = new wijmo.grid.FlexGrid('#theGrid', {
        ...
        columns: [
            ...
            { binding: 'bid', header: 'Bid', format: 'n2', width: 220, allowSorting: false },
            { binding: 'ask', header: 'Ask', format: 'n2', width: 220, allowSorting: false },
            { binding: 'lastSale', header: 'Last Sale', format: 'n2', width: 220, allowSorting: false },
            { binding: 'bidSize', header: 'Bid Size', format: 'n0', allowSorting: false },
            { binding: 'askSize', header: 'Ask Size', format: 'n0', allowSorting: false },
            { binding: 'lastSize', header: 'Last Size', format: 'n0', allowSorting: false },
            { binding: 'volume', header: 'Volume', format: 'n0', allowSorting: false },
            { binding: 'quoteTime', header: 'Quote Time', format: 'hh:mm:ss', align: 'center', allowSorting: false },
            { binding: 'tradeTime', header: 'Trade Time', format: 'hh:mm:ss', align: 'center', allowSorting: false },
        ],
        itemsSource: data
    });
    ...
    function updateGrid(changedItems) {
        ...
        if (theGrid.collectionView.sortDescriptions.length) {
