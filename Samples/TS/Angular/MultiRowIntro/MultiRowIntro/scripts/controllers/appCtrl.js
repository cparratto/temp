...
app.controller('appCtrl', function appCtrl($scope) {
    ...
    $scope.orders = new wijmo.collections.CollectionView(orders);
    ...
    $scope.orders.collectionChanged.addHandler(function () {
        ...
        if (!pagedOrdersRefreshing) {
            $scope.pagedOrders.refresh();
        }
        if (!groupedOrdersRefreshing) {
            $scope.groupedOrders.refresh();
        }
        if (!addNewOrdersRefreshing) {
            $scope.addNewOrders.refresh();
        }
        ordersRefreshing = false;
    });

    var addNewOrdersRefreshing = false;
    $scope.addNewOrders.collectionChanged.addHandler(function () {
    ...
    $scope.groupedOrders.collectionChanged.addHandler(function () {
    ...
    $scope.pagedOrders.collectionChanged.addHandler(function () {
    ...
    // setting collapsedHeaders to null shows group and column headers
