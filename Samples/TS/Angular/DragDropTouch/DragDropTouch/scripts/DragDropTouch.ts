module wijmo {
    ...
    export class DataTransfer {
        ...
        set dropEffect(value: string) {
            this._dropEffect = asString(value);
        }
        /**
        ...
        set effectAllowed(value: string) {
            this._effectAllowed = asString(value);
        }
        /**
        ...
        setDragImage(img: HTMLElement, offsetX: number, offsetY: number) {
            ...
            ddt._imgCustom = img;
            ddt._imgOffset = new Point(offsetX, offsetY);
        }
    }
    ...
    export class DragDropTouch {
        ...
        constructor() {
            ...
            assert(!DragDropTouch._instance, 'DragDropTouch instance already created.');
        ...
        _touchstart(e: any) {
            if (this._shouldHandle(e)) {
                ...
                var src = <HTMLElement>closest(e.target, '[draggable]');
        ...
        _getPoint(e: any, page?: boolean): Point {
            ...
            assert(e && ('clientX' in e), 'invalid event?');
            if (page == true) {
        ...
        _createImage(e: any) {
            ...
            if (!this._imgCustom) {
                var rc = src.getBoundingClientRect(),
                    pt = this._getPoint(e);
                this._imgOffset = new Point(pt.x - rc.left, pt.y - rc.top);
