module wijmo.grid.sheet.chart {
    ...
    export class ChartEngine {
        ...
        private _undoAction: _UndoAction;
        ...
        private _init() {
            ...
            self._owner.rowChanged.addHandler((sender: any, args: RowColumnChangedEventArgs) => {
                var chartObj: IChartObject,
                    currentAction: _UndoAction;
                ...
                if (currentAction instanceof _RowsChangedAction) {
            ...
            self._owner.columnChanged.addHandler((sender: any, args: RowColumnChangedEventArgs) => {
                var chartObj: IChartObject,
                    currentAction: _UndoAction;
                ...
                currentAction = self._owner.undoStack._pop();
                if (currentAction instanceof _ColumnsChangedAction) {
        ...
        _generateChartData(cellRanges?: CellRange[]) {
        ...
        _getChartSettings(): IChartSetting[] {
            ...
            for (var i = 0; i < this._charts.length; i++) {
                ...
                charts[i] = {
                    ...
                    chartRect: new Rect(chartHost.offsetLeft, chartHost.offsetTop, chartHost.offsetWidth, chartHost.offsetHeight),
                    chartContainerRect: new Rect(chartContainer.offsetLeft, chartContainer.offsetTop, chartContainer.offsetWidth, chartContainer.offsetHeight)
                };
            }
        ...
        private _cloneChartRanges(ranges: CellRange[]) {
            var cloneRanges = [];
    ...
    export interface IChartSetting {
        sheetIndex: number;
        cellRanges: CellRange[];
        chartType: wijmo.chart.ChartType;
        chartRect: Rect;
        chartContainerRect: Rect;
    }
}