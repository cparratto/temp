var GettingStarted = React.createClass({
    ...
    render: function () {
        return React.createElement("div", null,
            ...
            React.createElement("p", null, "Steps for getting started with Gauge controls in React applications:"),
            ...
            React.createElement("div", { className: "row" },
                ...
                React.createElement("div", { className: "col-md-6" },
                    ...
                    React.createElement(Wj.LinearGauge, { value: this.state.value, min: this.state.min, max: this.state.max, format: this.state.format }),
                    React.createElement(Wj.RadialGauge, { value: this.state.value, min: this.state.min, max: this.state.max, format: this.state.format }),
