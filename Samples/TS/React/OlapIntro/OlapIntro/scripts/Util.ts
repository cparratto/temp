module Util {
    ...
    export function getSimpleDataSet(cnt) {
    ...
    export function getDataSet(cnt) {
    ...
    export function getNorthwindOrders() {
    ...
    export function getViewTitle(ng: wijmo.olap.PivotEngine) {
        var title = '';
    ...
    export function addTitleCell(sheet: wijmo.xlsx.WorkSheet, title: string) {
    ...
    export function getEnumNames(enumClass) {
        var names = [];
