...
{
!(prop in ctl) || ctl[prop] instanceof wijmo.Event || wijmo.isUndefined(component[prop]) || (ctl[prop] = component[prop], component.$watch(prop, _updateControl.bind({
ctl: ctl, prop: prop
})))
...
{
var event=ctl[prop];
wijmo.isFunction(component[prop]) && event.addHandler(component[prop], ctl)
}
}), component.control && component.$parent && (component.$parent[component.control] = ctl), wijmo.isFunction(component.initialized) && component.initialized(ctl), ctl
}
...
{
var _this=this;
wijmo.httpRequest(this.src, {success: function(xhr)
{
...
template: '<div><slot/></div>', props: vue2._getProps('wijmo.grid.FlexGrid'), mounted: function()
{
var _this=this,
...
ctl = new wijmo.grid.FlexGrid(this.$el, {autoGenerateColumns: autoGenerateColumns});
this.$children.forEach(function(item)
{
var col,
filter;
...
filter = vue2._initialize(item, new wijmo.grid.filter.FlexGridFilter(ctl))
}
...
template: '<div/>', props: vue2._getProps('wijmo.grid.Column')
})
})(vue2 = wijmo.vue2 || (wijmo.vue2 = {}))
}(wijmo || (wijmo = {})),
function(wijmo)
...
template: '<div/>', props: vue2._getProps('wijmo.grid.filter.FlexGridFilter')
})
})(vue2 = wijmo.vue2 || (wijmo.vue2 = {}))
}(wijmo || (wijmo = {})),
function(wijmo)
...
template: '<div/>', props: vue2._getProps('wijmo.grid.grouppanel.GroupPanel'), mounted: function()
{
...
template: '<div><slot/></div>', props: vue2._getProps('wijmo.chart.FlexChart', ['tooltipContent']), mounted: function()
{
var _this=this,
...
template: '<div/>', props: vue2._getProps('wijmo.chart.Axis', ['wjProperty'])
});
vue2.WjFlexChartLegend = Vue.component('wj-flex-chart-legend', {
template: '<div/>', props: vue2._getProps('wijmo.chart.Legend')
});
vue2.WjFlexChartSeries = Vue.component('wj-flex-chart-series', {
template: '<div/>', props: vue2._getProps('wijmo.chart.Series')
})
})(vue2 = wijmo.vue2 || (wijmo.vue2 = {}))
}(wijmo || (wijmo = {})),
function(wijmo)
...
template: '<div><slot/></div>', props: vue2._getProps('wijmo.gauge.LinearGauge'), mounted: function()
{
...
template: '<div><slot/></div>', props: vue2._getProps('wijmo.gauge.BulletGraph'), mounted: function()
{
...
template: '<div><slot/></div>', props: vue2._getProps('wijmo.gauge.RadialGauge'), mounted: function()
{
...
template: '<div/>', props: vue2._getProps('wijmo.gauge.Range', ['wjProperty'])
})
})(vue2 = wijmo.vue2 || (wijmo.vue2 = {}))
}(wijmo || (wijmo = {})),
function(wijmo)
...
template: '<div/>', props: vue2._getProps('wijmo.olap.PivotGrid'), mounted: function()
{
vue2._initialize(this, new wijmo.olap.PivotGrid(this.$el))
}
});
vue2.WjPivotChart = Vue.component('wj-pivot-chart', {
template: '<div/>', props: vue2._getProps('wijmo.olap.PivotChart'), mounted: function()
{
vue2._initialize(this, new wijmo.olap.PivotChart(this.$el))
}
});
vue2.WjPivotPanel = Vue.component('wj-pivot-panel', {
template: '<div/>', props: vue2._getProps('wijmo.olap.PivotPanel'), mounted: function()
{
...
template: '<div/>', props: vue2._getProps('wijmo.viewer.ReportViewer'), mounted: function()
{
vue2._initialize(this, new wijmo.viewer.ReportViewer(this.$el))
}
});
vue2.WjPdfViewer = Vue.component('wj-pdf-viewer', {
template: '<div/>', props: vue2._getProps('wijmo.viewer.PdfViewer'), mounted: function()
{
...
template: '<div/>', props: vue2._getProps('wijmo.nav.TreeView'), mounted: function()
{
