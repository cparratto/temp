var Grouping = React.createClass({
    ...
    render: function () {
        return React.createElement("div", null,
            React.createElement("h2", null, "Grouping"),
            React.createElement("p", null,
                "FlexGrid supports grouping through the ",
                React.createElement("b", null, "ICollectionView"),
                " interface, which is identical to the one in .NET. To enable grouping, add one or more ",
                React.createElement("b", null, "GroupDescription"),
                " objects to the ",
                React.createElement("b", null, "CollectionView.groupDescriptions"),
                " property, and ensure that the grid's ",
                React.createElement("b", null, "showGroups"),
                " property is set to true (the default value)."),
            React.createElement("p", null,
                React.createElement("b", null, "GroupDescription"),
                " objects are flexible, allowing you to group data based on value or on grouping functions. The example below groups dates by year; amounts by range returning three ranges: over 5,000, 500 to 5,000, and under 500; and anything else by value. Use the menu to see the effects of each grouping."),
            React.createElement("p", null,
                "Notice that the \"Revenue\" column displays the totals in the group rows. We do this by setting the column's ",
                React.createElement("b", null, "aggregate"),
                " property to \"Sum.\" The aggregate is automatically updated when you edit the values in the column."),
            React.createElement("div", { className: "row" },
                React.createElement("div", { className: "col-md-6" },
                    React.createElement("ul", { className: "nav nav-tabs", role: "tablist" },
                        React.createElement("li", { className: "active" },
                            React.createElement("a", { href: "#gpJsx", role: "tab", "data-toggle": "tab" }, "JSX")),
                        React.createElement("li", null,
                            React.createElement("a", { href: "#gpJs", role: "tab", "data-toggle": "tab" }, "JS"))),
                    React.createElement("div", { className: "tab-content" },
                        React.createElement("div", { className: "tab-pane active pane-content", id: "gpJsx" },
                            '<Wj.FlexGrid\n',
                        ...
                        React.createElement("div", { className: "tab-pane pane-content", id: "gpJs" },
                            'getInitialState: function () {\n',
                            '    var view = new wijmo.collections.CollectionView(Util.getData());\n',
                            '    var groupByOptions = new wijmo.collections.CollectionView([\n',
                            '        { name: \'no grouping\', groups: [] },\n',
                ...
                React.createElement("div", { className: "col-md-6" },
                    ...
                    React.createElement("label", { htmlFor: "cmbGrp" }, "Group By:\u00A0"),
                    React.createElement(Wj.ComboBox, { id: "cmbGrp", displayMemberPath: 'name', itemsSource: this.state.groupByOptions, textChanged: this.groupByChanged }))));
    }
});
