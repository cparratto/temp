...
var DataService = (function () {
    ...
    DataService.prototype.getData = function (count, allCountries) {
        if (allCountries === void 0) { allCountries = false; }
        var countries = allCountries ? this._allCountries : this._someCountries, data = [];
    ...
    DataService.prototype.getSomeCountries = function () {
    ...
    DataService.prototype.getMusicians = function () {
        return this._musicians;
    };
    DataService.prototype.getTreeData = function () {
        return [
            {
...
DataService.default = new DataService();
