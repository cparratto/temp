        ...
        (function (interaction) {
            ...
            var AxisScrollbar = (function () {
                ...
                function AxisScrollbar(axis, options) {
                    ...
                    this._isXAxis = this._axis.axisType === chart_1.AxisType.X;
                ...
                AxisScrollbar.prototype._refresh = function () {
                    ...
                    if (this._isXAxis) {
                        isBottom = this._axis.position === chart_1.Position.Bottom;
                        ...
                        isLeft = this._axis.position === chart_1.Position.Left;
