    ...
    angular
        ...
        .config(function ($routeProvider) {
            $routeProvider
                ...
                .when('/flexgridpdfconverter/custom-cell-content', {
                	templateUrl: 'views/flexGridPdfConverter/customCellContent.htm',
                	controller: 'fcCustomCellContentCtrl'
                })
                .when('/flexgridpdfconverter/formatItem-callback', {
                	templateUrl: 'views/flexGridPdfConverter/formatItemCallback.htm',
                	controller: 'fcFormatItemCallbackCtrl'
                })
                .when('/flexgridpdfconverter/drawing-cells-manually', {
                	templateUrl: 'views/flexGridPdfConverter/drawingCellsManually.htm',
                	controller: 'fcDrawingCellsManuallyCtrl'
                })
