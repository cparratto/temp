        ...
        (function (annotation) {
            ...
            var EditableAnnotationLayer = (function (_super) {
                ...
                function EditableAnnotationLayer(chart, options) {
                    ...
                    _this._hostMouseDown = null;
                    _this._hostMouseMove = null;
                    _this._hostMouseUp = null;
                    _this._hostMouseLeave = null;
                    _this._hostClick = null;
                    _this._hostDBLClick = null;
                    _this._isDragging = false;
                    //bind drag/drop event
                    _this._bindEditableEvent();
                    return _this;
                }
                ...
                EditableAnnotationLayer.prototype._onHostMouseDown = function (e) {
                    var self = this, rootEle = self._chart.hostElement, anno, pt = e instanceof MouseEvent ? new wijmo.Point(e.pageX, e.pageY) :
                        new wijmo.Point(e.changedTouches[0].pageX, e.changedTouches[0].pageY), pNode, del, btn, hostRect, plotRect = self._chart._plotRect, isDC = self._isDataCoordinate, textEditor = self._textEditor, dp;
                    if (!self._isEditable) {
                        return;
                    }
                    ...
                    if (anno != null) {
                        ...
                        if (!chart_1.FlexChart._contains(plotRect, pt)) {
                            return;
                        }
                        //inside plot rect
                ...
                EditableAnnotationLayer.prototype._convertLenToData = function (total, axis, val, converted) {
                    ...
                    if (isDate) {
                        ...
                        min = chart_1.FlexChart._toOADate(min);
                        max = chart_1.FlexChart._toOADate(max);
                    }
                    if (converted) {
                    ...
                    if (isDate) {
                        v = chart_1.FlexChart._fromOADate(v);
                    }
                    return v;
                };
                ...
                EditableAnnotationLayer.prototype._onHostMouseMove = function (e) {
                    ...
                    newPt = e instanceof MouseEvent ? new wijmo.Point(e.pageX, e.pageY) :
