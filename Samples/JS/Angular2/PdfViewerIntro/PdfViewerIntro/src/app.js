...
var AppCmp = (function () {
    function AppCmp() {
        this.serviceUrl = 'http://demos.componentone.com/ASPNET/c1webapi/4.0.20171.91/api/pdf';
        this.filePath = 'PdfRoot/C1XapOptimizer.pdf';
        this.fullScreen = false;
        this.mouseMode = wjcViewer.MouseMode.SelectTool;
        this.zoomFactor = 1;
...
], AppCmp.prototype, "pdfViewer", void 0);
AppCmp = __decorate([
    core_1.Component({
        selector: 'app-cmp',
