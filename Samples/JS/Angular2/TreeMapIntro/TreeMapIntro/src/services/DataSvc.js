...
var DataSvc = (function () {
    function DataSvc() {
        this.categories = ['Beverages', 'Condiments', 'Confections', 'Dairy Products', 'Grains/Cereals', 'Meat/Poultry', 'Produce', 'Seafood'];
        this.subCategories = [['Soft drinks', 'Coffees', 'Teas', 'Beers', 'Ales'], ['Sweet and Savory sauces', 'Relishes', 'Spreads', 'Seasonings'],
    ...
    DataSvc.prototype.getGroupCVData = function () {
        var data = [], len = 1000, catLen = this.categories.length, subCat, randomC, randomSC;
        for (var i = 0; i < len; i++) {
    ...
    ;
    DataSvc.prototype.getMaxDepthData = function () {
        var rand = this.rand;
        var data = [{
                type: 'Music',
                items: [{
