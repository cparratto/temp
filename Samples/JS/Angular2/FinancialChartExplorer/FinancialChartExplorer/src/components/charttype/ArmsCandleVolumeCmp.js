...
//ArmsCandleVolume sample component
var ArmsCandleVolumeCmp = (function () {
    function ArmsCandleVolumeCmp(dataSvc, tooltipSvc) {
        this.data = [];
        ...
        this.setDataSource();
        this.title = 'Arms CandleVolume';
    }
    ArmsCandleVolumeCmp.prototype.selectedSymbolChanged = function () {
        this.setDataSource();
    };
    ArmsCandleVolumeCmp.prototype.selectorChartRendered = function () {
    ...
    ArmsCandleVolumeCmp.prototype.chartRendered = function () {
        // customize tooltips
        if (this.chart) {
            this.chart.tooltip.content = this.tooltipSvc.getFinancialTooltip;
        }
    };
    ArmsCandleVolumeCmp.prototype.rangeChanged = function () {
    ...
    ArmsCandleVolumeCmp.prototype.setDataSource = function () {
        var _this = this;
    ...
    return ArmsCandleVolumeCmp;
}());
__decorate([
    core_1.ViewChild('chart')
], ArmsCandleVolumeCmp.prototype, "chart", void 0);
__decorate([
    core_1.ViewChild('selectorChart')
], ArmsCandleVolumeCmp.prototype, "selectorChart", void 0);
__decorate([
    core_1.ViewChild('selector')
], ArmsCandleVolumeCmp.prototype, "selector", void 0);
ArmsCandleVolumeCmp = __decorate([
    core_1.Component({
        selector: 'arms-candle-volume-cmp',
        templateUrl: 'src/components/charttype/ArmsCandleVolumeCmp.html',
    }),
    __param(0, core_1.Inject(DataSvc_1.DataSvc)), __param(1, core_1.Inject(TooltipSvc_1.TooltipSvc))
], ArmsCandleVolumeCmp);
exports.ArmsCandleVolumeCmp = ArmsCandleVolumeCmp;
var routing = router_1.RouterModule.forChild([
    { path: '', component: ArmsCandleVolumeCmp }
]);
var ArmsCandleVolumeModule = (function () {
    function ArmsCandleVolumeModule() {
    }
    return ArmsCandleVolumeModule;
}());
ArmsCandleVolumeModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [ArmsCandleVolumeCmp],
    })
], ArmsCandleVolumeModule);
exports.ArmsCandleVolumeModule = ArmsCandleVolumeModule;
//# sourceMappingURL=ArmsCandleVolumeCmp.js.map