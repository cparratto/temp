...
onload = function () {
    ...
    app.dataSets = [
        { name: 'Simple (1k items)', value: getSimpleDataSet(1000) },
        { name: 'Simple (10k items)', value: getSimpleDataSet(10000) },
        { name: 'Complex (100 items)', value: getDataSet(100) },
        { name: 'Complex (50k items)', value: getDataSet(50000) },
        { name: 'Complex (100k items)', value: getDataSet(100000) },
    ...
    app.propertyChanged.addHandler(function (s, e) {
        switch (e.propertyName) {
            ...
            case 'totalsBeforeData':
                ...
                break;
            case 'showLegend':
                app.cmbShowLegend.text = e.newValue;
                break;
        }
    });
    ...
    app.loadView = function () {
        if (localStorage.viewDefinition) {
            ...
            app.chkTotalsBeforeData.checked = ng.totalsBeforeData;
        }
    }
    ...
    app.propertyChanged.addHandler(function (s, e) {
        switch (e.propertyName) {
            case 'data':
                ...
                app.rawGrid.isReadOnly = e.newValue instanceof wijmo.odata.ODataCollectionView;
                ...
                document.getElementById('readOnlyData').style.display = app.rawGrid.isReadOnly ? '' : 'none';
                break;
        }
    });
...
function getNorthwindOrders() {
    return new wijmo.odata.ODataCollectionView(urlNWind, 'Order_Details_Extendeds', {
        sortOnServer: false,
        pageOnServer: false,
...
function getNorthwindSales() {
    return new wijmo.odata.ODataCollectionView(urlNWind, 'Product_Sales_for_1997', {
        sortOnServer: false,
        pageOnServer: false,
        filterOnServer: false
    });
